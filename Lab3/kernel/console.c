...
PUBLIC void init_screen(TTY* p_tty)
{
	...
	if (nr_tty == 0) {
		...
		//re1 : clean the screen at the beginning------------------------------
	}
	clean(p_tty);
...
PUBLIC void clean(TTY* p_tty){
	...
	u32 times = p_tty->p_console->cursor - p_tty->p_console->original_addr;
	//printf("here1\n");
	if(times>0){
		int lines = SCREEN_WIDTH * ((p_tty->p_console->cursor - p_tty->p_console->original_addr) /SCREEN_WIDTH);
		while(times>0){
...
/*======================================================================*
			   out_char
 *======================================================================*/
PUBLIC void out_char(CONSOLE* p_con, char ch, int isTab)
{
